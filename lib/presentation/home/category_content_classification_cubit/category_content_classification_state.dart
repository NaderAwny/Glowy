...
part 'category_content_classification_state.freezed.dart';

@freezed
abstract class CategoryContentClassificationState
    with _$CategoryContentClassificationState {
  const factory CategoryContentClassificationState({
    FlowState? flowState,
