...
class ResponseMessage {
  ...
  // ignore: non_constant_identifier_names
  static String FORBIDDEN = AppStrings
      .forbiddenError; //  failure, API rejected request; //  failure, API rejected request
  // ignore: non_constant_identifier_names
  static String INTERNAL_SERVER_ERROR =
      AppStrings.internalServerError; // failure, crash in server side
  // ignore: non_constant_identifier_names
  static String NOT_FOUND = AppStrings.notFoundError;
  // local status code
  // ignore: non_constant_identifier_names
  ...
  // ignore: non_constant_identifier_names
  static String DEAFULT = AppStrings.defaultError;
}
